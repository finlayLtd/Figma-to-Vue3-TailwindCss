<template>
  <section class="bg-[url('../assets/images/grad2.png')] bg-[length:100%_auto] px-4 bg-bottom bg-no-repeat">
    <div class="container mx-auto my-[92px]">
...
import Slider from "../Helper/Slider.vue";
import STable from '../Helper/STable.vue'
...
const serverModels = {
  headings : ['Country' , 'CPU' , 'Bench' , 'Cores' , 'Base clock' , 'Turbo Clock' , 'RAM' , 'SSD' , 'DDoS' , 'Monthly price'],
  data : [
    {
      flag : 'de.svg',
      active : true,
...
.active-server {
  @apply bg-blue [&>*>*]:text-white [&>*>p>span]:text-white-50 !important
}
</style>
